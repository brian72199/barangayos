...
- **Database Backup** — Automatic S3 backups to Cloudflare R2 (configurable via admin UI)
...
| **Linting** | oxlint |
| **Infrastructure** | Docker, Cloudflare Tunnel, Cloudflare R2 (backup), GitHub Actions |
...
backend/
  pb_migrations/   PocketBase schema + RBAC migrations
  Dockerfile       Alpine + PocketBase binary
  docker-compose.yml  Production stack
  pocketbase-service.exe  Windows binary for testing
